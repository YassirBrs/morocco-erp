...
import { getEnterpriseResilienceReadiness, type EnterpriseResilienceReadiness } from '../../lib/api';
import {
  enterpriseResilienceFeatureByKey,
  enterpriseResilienceFeatureDefinitions,
  type EnterpriseResilienceFeatureKey,
  type EnterpriseResilienceMetric,
} from './enterprise-resilience-feature-config';

type EnterpriseResilienceFeaturePageProps = {
  data: EnterpriseResilienceReadiness;
  featureKey: EnterpriseResilienceFeatureKey;
};

export function makeEnterpriseResilienceServerSideProps(featureKey: EnterpriseResilienceFeatureKey): GetServerSideProps<EnterpriseResilienceFeaturePageProps> {
  return async () => ({
    props: {
      data: await getEnterpriseResilienceReadiness(),
      featureKey,
    },
  });
}

export function EnterpriseResilienceFeaturePage({ data, featureKey }: EnterpriseResilienceFeaturePageProps) {
  const definition = enterpriseResilienceFeatureByKey[featureKey];
        ...
        <aside className="sidebar">
          <div className="brand">
            ...
            <div>
              ...
              <small>Pages résilience Maroc</small>
            </div>
          </div>
          <nav aria-label="Fonctionnalités résilience entreprise">
        ...
        <section className="workspace">
          <header className="topbar">
            ...
            <div className="status">
              ...
              <strong>Résilience active</strong>
            </div>
          </header>
          ...
          <section className="gridTwo">
            <div className="panel">
              <PanelHeader title="Contrôles métier" action="Ouvrir revue" />
              <ul className="checks">
...
function formatMetric(source: unknown, metric: EnterpriseResilienceMetric): string {
