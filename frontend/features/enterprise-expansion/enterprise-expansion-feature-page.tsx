...
import { getEnterpriseExpansionReadiness, type EnterpriseExpansionReadiness } from '../../lib/api';
import {
  enterpriseExpansionFeatureByKey,
  enterpriseExpansionFeatureDefinitions,
  type EnterpriseExpansionFeatureKey,
  type EnterpriseExpansionMetric,
} from './enterprise-expansion-feature-config';

type EnterpriseExpansionFeaturePageProps = {
  data: EnterpriseExpansionReadiness;
  featureKey: EnterpriseExpansionFeatureKey;
};

export function makeEnterpriseExpansionServerSideProps(featureKey: EnterpriseExpansionFeatureKey): GetServerSideProps<EnterpriseExpansionFeaturePageProps> {
  return async () => ({
    props: {
      data: await getEnterpriseExpansionReadiness(),
      featureKey,
    },
  });
}

export function EnterpriseExpansionFeaturePage({ data, featureKey }: EnterpriseExpansionFeaturePageProps) {
  const definition = enterpriseExpansionFeatureByKey[featureKey];
        ...
        <aside className="sidebar">
          <div className="brand">
            ...
            <div>
              ...
              <small>Pages expansion Maroc</small>
            </div>
          </div>
          <nav aria-label="Fonctionnalités expansion entreprise">
        ...
        <section className="workspace">
          <header className="topbar">
            ...
            <div className="status">
              ...
              <strong>Expansion active</strong>
            </div>
          </header>
...
function formatMetric(source: unknown, metric: EnterpriseExpansionMetric): string {
