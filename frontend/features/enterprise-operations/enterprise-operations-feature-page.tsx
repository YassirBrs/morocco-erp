...
import { getEnterpriseOperationsReadiness, type EnterpriseOperationsReadiness } from '../../lib/api';
import {
  enterpriseOperationsFeatureByKey,
  enterpriseOperationsFeatureDefinitions,
  type EnterpriseOperationsFeatureKey,
  type EnterpriseOperationsMetric,
} from './enterprise-operations-feature-config';

type EnterpriseOperationsFeaturePageProps = {
  data: EnterpriseOperationsReadiness;
  featureKey: EnterpriseOperationsFeatureKey;
};

export function makeEnterpriseOperationsServerSideProps(featureKey: EnterpriseOperationsFeatureKey): GetServerSideProps<EnterpriseOperationsFeaturePageProps> {
  return async () => ({
    props: {
      data: await getEnterpriseOperationsReadiness(),
      featureKey,
    },
  });
}

export function EnterpriseOperationsFeaturePage({ data, featureKey }: EnterpriseOperationsFeaturePageProps) {
  const definition = enterpriseOperationsFeatureByKey[featureKey];
      ...
      <main className="shell featureShell">
        <aside className="sidebar">
          <div className="brand">
            ...
            <div>
              ...
              <small>Pages opérations Maroc</small>
            </div>
          </div>
          <nav aria-label="Fonctionnalités opérations entreprise">
        ...
        <section className="workspace">
          ...
          <section className="gridTwo">
            <div className="panel">
              <PanelHeader title="Contrôles opérationnels" action="Ouvrir workflow" />
              <ul className="checks">
...
function formatMetric(source: unknown, metric: EnterpriseOperationsMetric): string {
