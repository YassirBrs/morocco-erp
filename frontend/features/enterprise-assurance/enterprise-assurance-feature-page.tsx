...
import { getEnterpriseAssuranceReadiness, type EnterpriseAssuranceReadiness } from '../../lib/api';
import {
  enterpriseAssuranceFeatureByKey,
  enterpriseAssuranceFeatureDefinitions,
  type EnterpriseAssuranceFeatureKey,
  type EnterpriseAssuranceMetric,
} from './enterprise-assurance-feature-config';

type EnterpriseAssuranceFeaturePageProps = {
  data: EnterpriseAssuranceReadiness;
  featureKey: EnterpriseAssuranceFeatureKey;
};

export function makeEnterpriseAssuranceServerSideProps(featureKey: EnterpriseAssuranceFeatureKey): GetServerSideProps<EnterpriseAssuranceFeaturePageProps> {
  return async () => ({
    props: {
      data: await getEnterpriseAssuranceReadiness(),
      featureKey,
    },
  });
}

export function EnterpriseAssuranceFeaturePage({ data, featureKey }: EnterpriseAssuranceFeaturePageProps) {
  const definition = enterpriseAssuranceFeatureByKey[featureKey];
        ...
        <aside className="sidebar">
          <div className="brand">
            ...
            <div>
              ...
              <small>Pages assurance Maroc</small>
            </div>
          </div>
          <nav aria-label="Fonctionnalités assurance entreprise">
        ...
        <section className="workspace">
          <header className="topbar">
            ...
            <div className="status">
              ...
              <strong>Assurance active</strong>
            </div>
          </header>
...
function formatMetric(source: unknown, metric: EnterpriseAssuranceMetric): string {
